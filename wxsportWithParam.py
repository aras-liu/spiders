...
def getcode(username, password):
    redirect_url = 'https://s3-us-west-2.amazonaws.com/hm-registration/successsignin.html'
    url = f'https://api-user.huami.com/registrations/+86{username}/tokens'
...
#@app.route("/modifyStep", methods=['POST'])
def modifyStep(mobile,mypwd):
    min_step = 10999
    max_step = 16999
    ...
    try:
        ...
        print(f'{mobile}modify step fail {e}')
        status["status"] = "fail"
        return status
...
if __name__ == '__main__':
 #   app.run(debug=False, port=10999)
    print(sys.argv)
    modifyStep(sys.argv[1],sys.argv[2])
